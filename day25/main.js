...
$("#plus").click(function(){
    if (parseInt($("#inputadd").val()) != booklg){
        ...
        let r = Math.floor(Math.random()*booklg)
        // console.log(a);
        $("#row").append(`
...
function hamisi(){
   document.querySelector(".allphoto").classList.remove("d-none")
   document.querySelector(".etiraf").classList.add("d-none")
   document.querySelector(".sefiller").classList.add("d-none")
   document.querySelector(".bilim").classList.add("d-none")
   document.querySelector(".appe").classList.add("d-none")
}

function psixologiya(){
    document.querySelector(".etiraf").classList.remove("d-none")
    document.querySelector(".allphoto").classList.add("d-none")
    document.querySelector(".sefiller").classList.add("d-none")
    document.querySelector(".bilim").classList.add("d-none")
    document.querySelector(".appe").classList.add("d-none")
 }
 ...
 function roman(){
    document.querySelector(".sefiller").classList.remove("d-none")
    document.querySelector(".allphoto").classList.add("d-none")
    document.querySelector(".etiraf").classList.add("d-none")
    document.querySelector(".bilim").classList.add("d-none")
    document.querySelector(".appe").classList.add("d-none")
 ...
 function bilim(){
    document.querySelector(".bilim").classList.remove("d-none")
    document.querySelector(".sefiller").classList.add("d-none")
    document.querySelector(".allphoto").classList.add("d-none")
    document.querySelector(".etiraf").classList.add("d-none")
    document.querySelector(".appe").classList.add("d-none")
